...
readonly INI_SETTING_KEY_LIST=("${INI_TERMINAL_ON}" "${INI_OPEN_WHERE}" "${INI_TERMINAL_FOCUS}" "${INI_INPUT_EXECUTE}" "${INI_IN_EXE_DFLT_VL}" "${INI_INPUT_EXEC_ROOP_DO}" "${INI_INPUT_EXEC_DFLT_SAVE_DO}" "${INI_BEFORE_COMMAND}" "${INI_AFTER_COMMAND}" "${INI_CMD_FILE_NAME}")
...
readonly INI_INPUT_EXEC_DFLT_SAVE_DO_DEFAULT_GAIN="OFF"
...
readonly INI_SETTING_DEFAULT_GAIN_LIST=("${INI_TERMINAL_ON_DEFAULT_GAIN}" "${INI_OPEN_WHERE_DEFAULT_GAIN}" "${INI_TERMINAL_FOCUS_DEFAULT_GAIN}" "${INI_INPUT_EXEC_ROOP_DO_DEFAULT_GAIN}" "${INI_INPUT_EXEC_DFLT_SAVE_DO_DEFAULT_GAIN}" "${INI_BEFORE_COMMAND_DEFAULT_GAIN}" "${INI_AFTER_COMMAND_DEFAULT_GAIN}" "${INI_INI_CMD_FILE_NAME_DEFAULT_GAIN}")
...
${INI_INPUT_EXEC_DFLT_SAVE_DO}=${INI_INPUT_EXEC_DFLT_SAVE_DO_DEFAULT_GAIN}
${INI_BEFORE_COMMAND}=
${INI_AFTER_COMMAND}=
${INI_CMD_FILE_NAME}="
...
readonly INI_INPUT_EXEC_DFLT_SAVE_DO_DEFAULT_VALUE="OFF!ON"
...
${INI_INPUT_EXEC_DFLT_SAVE_DO}=${INI_INPUT_EXEC_DFLT_SAVE_DO_DEFAULT_VALUE}
