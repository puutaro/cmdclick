...
readonly INI_DEFAULT_VARIABLE_TYPE='dfltVarType'
readonly INI_INPUT_EXEC_ROOP_DO='inputExecRoopDo'
readonly INI_INPUT_EXEC_DFLT_SAVE_DO="inputExecSaveValDo"
readonly INI_BEFORE_COMMAND='beforeCommand'
readonly INI_AFTER_COMMAND='afterCommand'
readonly INI_CMD_FILE_NAME='shellFileName'
readonly INI_SETTING_KEY_LIST=("${INI_TERMINAL_ON}" "${INI_OPEN_WHERE}" "${INI_TERMINAL_FOCUS}" "${INI_EDIT_EXECUTE}" "${INI_DEFAULT_VARIABLE_TYPE}" "${INI_INPUT_EXEC_ROOP_DO}" "${INI_INPUT_EXEC_DFLT_SAVE_DO}" "${INI_BEFORE_COMMAND}" "${INI_AFTER_COMMAND}" "${INI_CMD_FILE_NAME}")
...
readonly INI_EDIT_EXECUTE_DEFAULT_GAIN="N"
readonly INI_DEFAULT_VARIABLE_TYPE_DEFAULT_GAIN=""
readonly INI_INPUT_EXEC_ROOP_DO_DEFAULT_GAIN="OFF"
...
readonly INI_SETTING_DEFAULT_GAIN_LIST=("${INI_TERMINAL_ON_DEFAULT_GAIN}" "${INI_OPEN_WHERE_DEFAULT_GAIN}" "${INI_TERMINAL_FOCUS_DEFAULT_GAIN}" "${INI_INPUT_EXEC_ROOP_DO_DEFAULT_GAIN}" "${INI_BEFORE_COMMAND_DEFAULT_GAIN}" "${INI_AFTER_COMMAND_DEFAULT_GAIN}" "${INI_INI_CMD_FILE_NAME_DEFAULT_GAIN}")
...
${INI_INPUT_EXEC_ROOP_DO}=${INI_INPUT_EXEC_ROOP_DO_DEFAULT_GAIN}
${INI_BEFORE_COMMAND}=
${INI_AFTER_COMMAND}=
${INI_CMD_FILE_NAME}="
...
readonly INI_EDIT_EXECUTE_DEFAULF_VALUE="N!C"
readonly INI_DEFAULT_VARIABLE_TYPE_DEFAULT_VALUE=""
readonly INI_INPUT_EXEC_ROOP_DO_DEFAULF_VALUE="OFF!ON"
...
${INI_DEFAULT_VARIABLE_TYPE}=${INI_DEFAULT_VARIABLE_TYPE_DEFAULT_VALUE}
${INI_INPUT_EXEC_ROOP_DO}=${INI_INPUT_EXEC_ROOP_DO_DEFAULF_VALUE}
